...
const recognizers_1 = require("../../linter/recognizers");
...
function containsCode(value) {
    ...
    try {
        const options = (0, parsers_1.buildParserOptions)({ filePath: 'some/filePath', tsConfigs: [], fileContent: '', fileType: 'MAIN' }, true);
