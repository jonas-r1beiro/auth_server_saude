...
exports.rule = {
    ...
    create(context) {
        ...
        function visitCallback(node) {
            ...
            (0, linter_1.childrenOf)(node, context.getSourceCode().visitorKeys).forEach(visitCallback);
        }
        ...
        return {
            CallExpression: (node) => {
                ...
                if ((0, helpers_1.getFullyQualifiedName)(context, callExpression) === 'passport.authenticate') {
