...
exports.rule = {
    ...
    create(context) {
        ...
        function usesSesCommunication(sesProperty) {
            ...
            const ses = (0, helpers_1.getValueOfExpression)(context, (_a = (0, helpers_1.getObjectExpressionProperty)(configuration, 'ses')) === null || _a === void 0 ? void 0 : _a.value, 'NewExpression');
