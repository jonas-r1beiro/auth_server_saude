...
exports.rule = void 0;
const rule_1 = require("../S2598/rule");
...
function checkCallExpression(context, callExpression) {
    ...
    const fqn = (0, helpers_1.getFullyQualifiedName)(context, identifierFromModule);
    if (!fqn) {
        return;
    }
...
function visitAssignment(context, assignment) {
    const variableProperty = (0, rule_1.getVariablePropertyFromAssignment)(context, assignment);
    if (!variableProperty) {
        return;
    }
