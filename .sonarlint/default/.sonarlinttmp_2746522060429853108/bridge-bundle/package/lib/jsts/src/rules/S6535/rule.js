...
exports.rule = {
    ...
    create(context) {
        ...
        const notThisBeforeSuperListener = noNonoctalDecimalEscapeRule.create(context);
        return (0, helpers_1.mergeRules)(noUselessEscapeListener, notThisBeforeSuperListener);
    },
};
