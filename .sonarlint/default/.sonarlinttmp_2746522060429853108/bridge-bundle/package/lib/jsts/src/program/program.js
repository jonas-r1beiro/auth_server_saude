...
exports.writeTSConfigFile = exports.isRoot = exports.isRootNodeModules = exports.deleteProgram = exports.getProgramById = exports.createAndSaveProgram = exports.createProgram = exports.createProgramOptions = exports.getProgramForFile = exports.programCache = void 0;
...
const cache_1 = require("@sonar/shared/helpers/cache");
exports.programCache = new cache_1.ProgramCache();
let projectTSConfigs;
function getDefaultTSConfigs() {
    if (!projectTSConfigs) {
        projectTSConfigs = new helpers_1.ProjectTSConfigs();
    }
 ...
 */
function getProgramForFile(input, cache = exports.programCache, tsconfigs) {
    if (!tsconfigs) {
    ...
    if (tsconfigs.reloadTsConfigs(input.forceUpdateTSConfigs) || newTsConfigs) {
        exports.programCache.clear();
    }
    const normalizedPath = (0, helpers_1.toUnixPath)(input.filePath);
...
exports.getProgramForFile = getProgramForFile;
/**
...
function createProgram(tsConfig, tsconfigContents) {
    if (!tsconfigContents) {
        tsconfigContents = (0, helpers_1.readFileSync)(tsConfig);
    }
    ...
    for (const reference of inputProjectReferences) {
        const sanitizedReference = (0, helpers_1.addTsConfigIfDirectory)(reference.path);
...
function isRoot(file) {
    return (0, helpers_1.toUnixPath)(file) === (0, helpers_1.toUnixPath)(path_1.default.parse(file).root);
}
